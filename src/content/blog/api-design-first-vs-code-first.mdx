...
There are [a few approaches](/blog/keeping-documentation-honest), but even if you absolutely nail using Dredd or similar tooling to keep things synced up, there is the other rather large problem we've not covered yet: the fact that you built the whole API before giving your customers a chance to play with it. Mocking is too often overlooked, and people waste time and money building out nonsense APIs which don't help their customers, meaning a v2 comes quickly after, and maybe a v3 as a few more clients get involved. Or you [chose to use evolution](/blog/api-evolution-for-rest-http-apis/) and now have really bloated resources because what you initially had and what customers needed is way out of line, but you already have some customers in prod and can't remove things just yet. 🤦🏻‍♂️
